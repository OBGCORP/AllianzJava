...
import com.allianz.customerERP.model.OrderDTO;
import com.allianz.customerERP.service.OrderService;
...
public class OrderController {
    ...
    public ResponseEntity<List<OrderEntity>> getByStatus(@PathVariable String status) {
        EOrderStatus status2 = null;
        for (EOrderStatus status1 : EOrderStatus.values()) {
